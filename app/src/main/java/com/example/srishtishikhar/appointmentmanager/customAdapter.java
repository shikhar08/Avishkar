...
public class customAdapter extends ArrayAdapter<Doctors> {
    ...
    ListView objects;
   // float c,d;
    public customAdapter(@NonNull Context context, @NonNull ListView objects) {
        super(context, 0, (List<Doctors>) objects);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
       ...
       // double distance=meterDistanceBetweenPoints(a,b);
...
//        String val = String.valueOf(distance);
      //  Log.e("DISTANCE",""+distance);
       // Log.e("distance",""+a+" "+b+" ";
        ...
        TextView starth=(TextView)view.findViewById(R.id.start_hour);
        starth.setText(doctors.starttime);

        TextView startm=(TextView)view.findViewById(R.id.end_hour);
        startm.setText(doctors.endtime);
